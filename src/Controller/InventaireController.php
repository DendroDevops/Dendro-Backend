...
class InventaireController extends AbstractController
{
    ...
    /**
     * @Route("/stat/{user}", name="get_stat_inventory_user", methods="GET", defaults={"user": null})
     * @SWG\Response(
     *  response=200,
     *     description="return the stat of Inventories by user",
     * )
     * @SWG\Parameter(
     *     name="id user",
     *     in="path",
     ...
     * @return JsonResponse
     */
    public function statInventaires(Request $request,$user): JsonResponse
    {
        $result = $this->service->getStatInventory($request,$user);
